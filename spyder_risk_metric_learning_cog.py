...
#########
X = np.array(df[['MOCATOTS', 'CRAFTVRS', 'CRAFTURS', 'UDSBENTC', 'DIGFORCT', 'DIGFORSL', 'DIGBACCT', 'DIGBACLS', 'ANIMALS', 'VEG', 'TRAILA', 'TRAILB', 'CRAFTDVR', 'CRAFTDRE', 'UDSBENTD', 'MINTTOTS', 'UDSVERFC', 'UDSVERLC', 'UDSVERTN', 'TRAILARR','TRAILBRR', 'TRAILALI', 'TRAILBLI', 'TRAILAADJ', 'TRAILBADJ', 'JOLO_TOTAL_CORRECT', 'REY1_5REC', 'REY6REC', 'REYDREC', 'REYTCOR', 'REYFPOS', 'REYSUMREC', 'RECOGNITION_PC', 'STPR', 'LTPR', 'MEM_EFF_SCORE'] ]  )
y = np.array( df.DEMENTED)
...
nca3 = NCA(random_state=2)
nca3.fit(X_clean, y_clean)

metric_fun3 = nca3.get_metric()
...
def cog_of_distances(df1, df2):
    distance_matrix = np.zeros((df1.shape[0], df2.shape[0]))
    for i in range(df1.shape[0]):
        for j in range(df2.shape[0]):
            distance_matrix[i, j] = metric_fun3(df1.iloc[i], df2.iloc[j])
    return distance_matrix
...
df_distances_cog =   pd.DataFrame(cog_of_distances(df[['MOCATOTS', 'CRAFTVRS', 'CRAFTURS', 'UDSBENTC', 'DIGFORCT', 'DIGFORSL', 'DIGBACCT', 'DIGBACLS', 'ANIMALS', 'VEG', 'TRAILA', 'TRAILB', 'CRAFTDVR', 'CRAFTDRE', 'UDSBENTD', 'MINTTOTS', 'UDSVERFC', 'UDSVERLC', 'UDSVERTN', 'TRAILARR','TRAILBRR', 'TRAILALI', 'TRAILBLI', 'TRAILAADJ', 'TRAILBADJ', 'JOLO_TOTAL_CORRECT', 'REY1_5REC', 'REY6REC', 'REYDREC', 'REYTCOR', 'REYFPOS', 'REYSUMREC', 'RECOGNITION_PC', 'STPR', 'LTPR', 'MEM_EFF_SCORE'] ], risky[['MOCATOTS', 'CRAFTVRS', 'CRAFTURS', 'UDSBENTC', 'DIGFORCT', 'DIGFORSL', 'DIGBACCT', 'DIGBACLS', 'ANIMALS', 'VEG', 'TRAILA', 'TRAILB', 'CRAFTDVR', 'CRAFTDRE', 'UDSBENTD', 'MINTTOTS', 'UDSVERFC', 'UDSVERLC', 'UDSVERTN', 'TRAILARR','TRAILBRR', 'TRAILALI', 'TRAILBLI', 'TRAILAADJ', 'TRAILBADJ', 'JOLO_TOTAL_CORRECT', 'REY1_5REC', 'REY6REC', 'REYDREC', 'REYTCOR', 'REYFPOS', 'REYSUMREC', 'RECOGNITION_PC', 'STPR', 'LTPR', 'MEM_EFF_SCORE'] ]),index=df.index, columns=risky.index)
df_distances_cog[np.isnan(df_distances_cog)] = 0.01
...
df_distances_cog['average_distance_cog'] = df_distances_cog.mean(axis=1)
df = df.join(df_distances_cog['average_distance_cog'])
...
simmilarity= (1/filtered['average_distance']) / np.max(1/filtered['average_distance']) + (1/filtered['average_distance_bio']) / np.max(1/filtered['average_distance_bio'])  +  (1/filtered['average_distance_cog']) / np.max(1/filtered['average_distance_cog'])  
simmilarity = simmilarity /3
