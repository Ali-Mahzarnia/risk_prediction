...
path_master='/Users/ali/Desktop/Jan24/ADRC/ADRC_connectome_bank/new_data_grid-export.csv'
...
#sum(is.na(connectivity))
 ...
 save(connectivity, file="connectivity_fmri.rda")
...
writeMat(con ="fmri.mat" ,response=response, connectivity=connectivity )
